...
precis(model)
```
What we see is that the intercept ($\alpha$) is approximately 154 cm (the !Kung people seems to be short), and there's a positive $\beta_w$ parameter, i.e., weight and height goes partly hand in hand.
